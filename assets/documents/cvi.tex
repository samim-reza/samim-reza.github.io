...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{%
    \raisebox{-4cm}{\hspace{\dimexpr\paperwidth-4cm\relax}%
      \begin{tikzpicture}
        \clip circle (1.7cm);
        \node at (0,0) {\includegraphics[width=2.6cm]{samim.jpg}};
      \end{tikzpicture}%
    }%
  }%
}
...
\vspace{0.2cm}
\textbf{Lead Engineer} | \textit{SolaneCode, New York} \hfill [\href{https://restaurant.sloancode.com/}{Live Platform}] \textcolor{lightgray}{May 2026 -- Present}
